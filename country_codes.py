...
Yugoslavia/Serbia and Montenegro) so back-file ingest does not silently
...
VALID_CC: frozenset[bytes] = frozenset(
    {
        b"AL", b"AP", b"AR", b"AT", b"AU",
        b"BA", b"BE", b"BG", b"BR",
        b"CA", b"CH", b"CL", b"CN", b"CO", b"CR", b"CS", b"CU", b"CY", b"CZ",
        b"DD", b"DE", b"DK", b"DZ",
        b"EA", b"EC", b"EE", b"EG", b"EP", b"ES",
        b"FI", b"FR",
        b"GB", b"GC", b"GE", b"GR", b"GT",
        b"HK", b"HR", b"HU",
        b"ID", b"IE", b"IL", b"IN", b"IS", b"IT",
        b"JP",
        b"KE", b"KR",
        b"LI", b"LT", b"LU", b"LV",
        b"MA", b"MC", b"MD", b"ME", b"MK", b"MN", b"MT", b"MW", b"MX", b"MY",
        b"NC", b"NI", b"NL", b"NO", b"NZ",
        b"OA",
        b"PA", b"PE", b"PH", b"PL", b"PT",
        b"RO", b"RS", b"RU",
        b"SE", b"SG", b"SI", b"SK", b"SM", b"SU", b"SV",
        b"TJ", b"TR", b"TT", b"TW",
        b"UA", b"US", b"UY",
        b"VN",
        b"WO",
